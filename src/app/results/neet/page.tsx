...
import { ArrowLeft, UserCircle2, Star } from "lucide-react";
import YearFilter from "../YearFilter";

export const metadata = {
  title: "NEET Results | MIITJEE Classes — Patna",
  description: "Explore the outstanding NEET results achieved by MIITJEE students.",
};

export default async function NEETResultsPage({
  searchParams,
}: {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
          <div>
            ...
            <p className="text-gray-600 text-lg">
              Celebrating our future doctors who achieved top ranks in NEET.
            </p>
          </div>
